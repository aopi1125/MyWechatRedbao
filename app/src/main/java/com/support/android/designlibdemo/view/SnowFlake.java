...
class SnowFlake {
    ...
    public static SnowFlake create(int width, int height, Paint paint) {
        ...
        float increment = random.nextInt((int) INCREMENT_UPPER);
        float flakeSize = random.nextInt((int) FLAKE_SIZE_UPPER);
    ...
    private void move(int width, int height) {
        ...
        angle += random.nextInt((int) ANGLE_SEED) / ANGLE_DIVISOR;
